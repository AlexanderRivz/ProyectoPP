...
import com.mdpustudio.proyectobuy4you.fragments.consumidor.infoproducto.InfoProductoFragment;
...
public class ProductosProveedorFragment extends Fragment {
    ...
    public static ProductosProveedorFragment newInstance(Persona persona, Usuario user, Proveedor proveedor) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = root.findViewById(R.id.fragmentproductosproveedor_recyclerview);
        ...
        descripcionProveedor.setText(selectedProveedor.getDescripcionProveedor());
    ...
    ProductosProveedorFragmentCommunication pCommunication = new ProductosProveedorFragmentCommunication() {
        ...
        public void sendProducto(Producto productoSent) {
            Fragment infoProducto = InfoProductoFragment.newInstance(selectedPersona, selectedUser, productoSent);
