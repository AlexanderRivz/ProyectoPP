package com.mdpustudio.proyectobuy4you.fragments.consumidor.modificardatosuser;
...
public class ModificarDatosFragment extends Fragment {
    ...
    public static ModificarDatosFragment newInstance(Persona persona, Usuario user) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        modificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentpassedit.getText().toString() == (selectedPersona.getPassword())){
                    flag = false;
                ...
                if (flag){
                    ...
                    selectedPersona.setEmail(Objects.requireNonNull(emailedit.getText()).toString());
                    selectedPersona.setUsername(Objects.requireNonNull(useredit.getText()).toString());
                    selectedPersona.setPassword(Objects.requireNonNull(confnewpassedit.getText()).toString());
