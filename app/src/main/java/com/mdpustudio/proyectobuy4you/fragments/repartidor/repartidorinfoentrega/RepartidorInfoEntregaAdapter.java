...
public class RepartidorInfoEntregaAdapter extends RecyclerView.Adapter<RepartidorInfoEntregaAdapter.ViewHolder> {

    private ArrayList<CarritoCompra> carritoProductos;

    RepartidorInfoEntregaAdapter(ArrayList<CarritoCompra> carritoProductos){
